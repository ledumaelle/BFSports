        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> BF SPORTS </a> <!-- lien sur l'entrep -->
                ...
                <?php else : ?>    
                    <li class="active"><a href=" <?php echo site_url('visiteur/afficherAccueil') ?> "> Accueil</a></li> 
                    <!-- active qd c'est sa page de seléctionner -->
                    ...
                    <form class="navbar-form navbar-left" action="<?php echo site_url('visiteur/afficherBoutique') ?>" method="GET" accept-charset="UTF-8" name="SearchWords">
                        <div class="form-group">
                            <input type="keywords" class="form-control" autocomplete="off" placeholder="Recherche" name="search">
                            <input type="submit" class="btn btn-warning">
                        </div>
                        <!-- <button type="submit" class="header-sprite">Rechercher</button> -->
                    </form>
                <?php endif; ?>
                </ul>
                ...
                <?php endif; ?>
                    ...
                    <!-- qd session ouverte enleve se connecter et inscription et affiche se déconnecter-->
                </ul>
            </div>
        </nav> 
    </header>   