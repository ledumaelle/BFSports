    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <img src=" <?php echo img_url('equipement.jpg') ?>" width="100%" height="35%"/>
                </div>
                <div class="col-sm-3">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php if (!($lesProduits ==null)):
                                ...
                                echo  '<tr>  
                                            <td class="col-sm-2"> <img  width="30%" src="'. img_url($unProduit['NOMIMAGE']) .'"/> <h5>'.anchor('visiteur/voirUnProduit/'.$unProduit['NOPRODUIT'],$unProduit['LIBELLE']).'</h5></td>
